...
- The app brand is MangoSoft. `activity_login.xml` renders the login wordmark from `res/drawable-nodpi/mangosoft_logo.png`; keep this asset transparent/cropped so it blends into the login background without a white rectangle.
